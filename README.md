...
| **SwiftData** | 8 | Models, queries, relationships, migrations, CloudKit sync and patterns |
| **Swift Charts** | 12 | Bar, line, area, pie, scatter - marks, scales, axes, annotations and interactivity |
