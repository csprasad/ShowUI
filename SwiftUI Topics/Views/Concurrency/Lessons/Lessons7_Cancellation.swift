...
struct CancellationExplanation: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            CalloutBox(style: .info, title: "Polling — the common case", content: "Check before each unit of work. If cancelled, CancellationError is thrown and the task unwinds cleanly.")
            CodeBlock(code: """
for item in items {
...
""")
            CalloutBox(style: .warning, title: "Advanced — react mid-suspension", content: "checkCancellation only fires when execution reaches that line. If your task is suspended inside a long call, use withTaskCancellationHandler.")
            CodeBlock(code: """
